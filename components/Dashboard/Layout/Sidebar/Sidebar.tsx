            ...
            >
                <div id='topsection' className='w-full h-auto px-5 pt-5 flex flex-col gap-6'>
                    <div className='flex items-center w-full h-10 gap-4'>
                        ...
                        <div>
                            ...
                            <h3 className='text-sm text-muted-foreground'>Member Plan</h3>
                        </div>
                    </div>
                    <SearchCommand />
                    <div className='flex flex-col gap-1 -mt-2'>
                        ...
                        <LinkButton icon={<User />} href='/profile' text='Account' command='c' />
                    </div>
                ...
                >
                    <div>
                        ...
                        <LinkButton icon={<Dumbbell />} href='/workouts' text='Workouts' />
                        <LinkButton icon={<Activity />} href='/exercises' text='Exercises' />
                        <LinkButton icon={<Warehouse />} href='/gym' text='Your Gym' />
                    </div>
                    <div>
                        <LinkButton
                            icon={<Settings />}
