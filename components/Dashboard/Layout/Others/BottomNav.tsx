...
export default function BottomNav({ pathname }: { pathname: string }) {
    return (
        ...
        >
            ...
            <NavLink pathname={pathname} href={"explore"} text={"Explore"} icon={<Search />} />
            <NavLink pathname={pathname} href={"workouts"} text={"Workouts"} icon={<Dumbbell />} />
            <NavLink pathname={pathname} href={"gym"} text={"Gym"} icon={<Warehouse />} />
            <NavLink pathname={pathname} href={"profile"} text={"Profile"} icon={<User />} />
        </div>
    );
}
