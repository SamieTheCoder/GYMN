...
export default function ExerciseSelector({
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["exercises", muscles, equipment, level],
        queryFn: () => {
            return axios
    ...
    return (
        <>
            ...
            <DrawerTitle screenWidth={screenWidth}>Exercises</DrawerTitle>
            <DrawerDescription screenWidth={screenWidth}>
                Click on exercises to select them, then press "Add".
            </DrawerDescription>
            <div
                id='options'
            ...
            >
                ...
                >
                    <Filter
                        title='Muscle'
                        description='Select the muscle to filter the results.'
                        setterFn={setMuscles}
                        ...
                        trigger={
                            ...
                            >
                                {muscles ? muscles : "Select muscle"}
                            </Button>
                        }
                    />
                    <Filter
                        title='Equipment'
                        description='Select the equipment to filter the results.'
                    ...
                    <Filter
                        title='Difficulty'
                        description='Select the difficulty to filter the results.'
                        setterFn={setLevel}
                        options={levels}
                        state={level}
                        trigger={
