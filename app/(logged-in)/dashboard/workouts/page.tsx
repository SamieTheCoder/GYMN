...
export default function Workouts() {
    ...
    return (
        <>
            ...
            <h2 className='text-xl font-semibold mt-4'>Your workouts</h2>
            <p className='text-sm text-muted-foreground'>
                View workouts created by you or your gym.
            </p>
                        ...
                        {data?.data?.length == 0 ? (
                            <div className='col-span-3 row-span-3 w-full aspect-video mt-6 bg-card rounded-lg border-dashed border-[2px] flex items-center justify-center flex-col space-y-4 p-6'>
                                ...
                                <p className='max-w-sm text-sm text-muted-foreground text-center '>
                                    Start your fitness journey by creating a workout and adding
                                    some exercises.
                                </p>
                                <Link href='/dashboard/workouts/new'>
                                    <Button variant={"secondary"}>New workout</Button>
                                </Link>
                            </div>
                        ) : (
                            <>
