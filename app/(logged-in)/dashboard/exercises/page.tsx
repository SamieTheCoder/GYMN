...
export default function Exercises() {
    ...
    const renderTitle = () => {
        if (queryParams.muscle && queryParams.equipment) {
            return `Exercises for ${queryParams.muscle} using ${queryParams.equipment}`;
        }
        if (queryParams.muscle) return `Exercises for ${queryParams.muscle}.`;
        if (queryParams.equipment) return `Exercises with ${queryParams.equipment}`;
        else {
